...
ax.set_title("Mean Differences of DCM and Quaternion_semilogy")
...
print("-------Quaternion-----------------------")
(X1, X2, MEANDIFF, MINDIFF, MAXDIFF, TIME) = f.Quaternion_rotation_precision(30, 10, np.pi / 2, np.pi / 2, np.pi / 2)
fig, ax = plt.subplots()
...
print("-------DCM-----------------------")
(X1, X2, MEANDIFF, MINDIFF, MAXDIFF, TIME) = f.DCM_rotation_precision(30, 10, np.pi / 2, np.pi / 2, np.pi / 2)
fig, ax = plt.subplots()
ax.loglog(X1, MEANDIFF, 'k--', label = 'Mean', color = 'red')
ax.loglog(X1, MINDIFF, 'k:', label = 'MIN', color = 'green')
ax.loglog(X1, MAXDIFF, 'k', label = 'MAX', color = 'blue')
...
(X1, X2, DIFF_CHECK_Q, DIFF_CHECK_DCM) = f.DCM_Quaternion_rotator_check3(30, 10, np.pi, np.pi, np.pi)
