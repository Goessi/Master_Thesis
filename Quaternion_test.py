...
(X1, X2, DIAGONAL_CHECK_Q, OFF_DIAGONAL_CHECK_Q, DIAGONAL_CHECK_DCM, OFF_DIAGONAL_CHECK_DCM) = f.DCM_Quaternion_rotator_check0(3000, 1000, np.pi / 2, np.pi / 2, np.pi / 2)
...
(X1, X2, ORTHONORMALITY_COL_Q, ORTHONORMALITY_ROW_Q, ORTHONORMALITY_COL_DCM, ORTHONORMALITY_ROW_DCM) = f.DCM_Quaternion_rotator_check1(3000, 1000, np.pi / 2, np.pi / 2, np.pi / 2)
...
(X1, X2, DIFF_CHECK_Q, DIFF_CHECK_DCM) = f.DCM_Quaternion_rotator_check2(3000, 1000, np.pi / 2, np.pi / 2, np.pi / 2)
...
(X1, X2, DIFF_CHECK_Q, DIFF_CHECK_DCM) = f.DCM_Quaternion_rotator_check3(3000, 1000, np.pi / 2, np.pi / 2, np.pi / 2)
