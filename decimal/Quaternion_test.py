# -*- coding: utf-8 -*-
"""
Created on Tue Jan  8 22:10:13 2019
...
A = Quaternion(d.Decimal('-1.0'), d.Decimal('2.0'), d.Decimal('3.0'), d.Decimal('4.0'))
B = Quaternion(d.Decimal('5.0'), d.Decimal('6.0'), d.Decimal('7.0'), d.Decimal('8.0'))
C = A + B
print(A)
print(B)
print(C)
...
E = Quaternion(d.Decimal(1.3), d.Decimal(2.0), d.Decimal(3.0), d.Decimal(4.0))
F = Quaternion(d.Decimal(-2.0), d.Decimal(6.0), d.Decimal(7.0), d.Decimal(8.0))
G = E - F
print(E)
print(F)
print(G)
...
E = Quaternion(d.Decimal(1.1), d.Decimal(2.0), d.Decimal(3.0), d.Decimal(4.0))
F = Quaternion(d.Decimal(-2.0), d.Decimal(6.0), d.Decimal(7.0), d.Decimal(8.0))
G = E.dot(F)
print(E)
print(F)
...
E = Quaternion(d.Decimal(1.0), d.Decimal(2.0), d.Decimal(3.0), d.Decimal(4.0))
F = Quaternion(d.Decimal(-2.0), d.Decimal(6.0), d.Decimal(7.0), d.Decimal(8.0))
G = E * F
print(E)
print(F)
...
E = Quaternion(d.Decimal(0.0), d.Decimal(1.0), d.Decimal(1.0), d.Decimal(1.0))
D = E.toDCM()
print(D)
...
fig.savefig('Quaternion_rotation_Precision_loglog_test.png', dpi = 100)
...
plt.show()
fig.set_size_inches(18.5, 10.5)
fig.savefig('Time_Quaternion1_test.png', dpi = 100)
...
plt.show()
fig.set_size_inches(18.5, 10.5)
fig.savefig('DCM_rotation_Precision_loglog_test.png', dpi = 100)
...
plt.show()
fig.set_size_inches(18.5, 10.5)
fig.savefig('Time_DCM1_test.png', dpi = 100)
...
plt.show()
fig.set_size_inches(18.5, 10.5)
fig.savefig('DCM_Quaternion_Precision_loglog_test.png', dpi = 100)
...
plt.show()
fig.set_size_inches(18.5, 10.5)
fig.savefig('DCM_Quaternion_Precision_semilog_test.png', dpi = 100)
...
#plt.show()
#fig.set_size_inches(18.5, 10.5)
#fig.savefig('DCM_Quaternion_diagonal_check_test.png', dpi = 100)
#
#fig, ax = plt.subplots()
...
#plt.show()
#fig.set_size_inches(18.5, 10.5)
#fig.savefig('DCM_Quaternion_off_diagonal_check_test.png', dpi = 100)
#
#fig, ax = plt.subplots()
...
#plt.show()
#fig.set_size_inches(18.5, 10.5)
#fig.savefig('DCM_Quaternion_orthonormality_row_check_test.png', dpi = 100)
#
#fig, ax = plt.subplots()
...
#plt.show()
#fig.set_size_inches(18.5, 10.5)
#fig.savefig('DCM_Quaternion_orthonormality_col_check_test.png', dpi = 100)
#
#
...
#plt.show()
#fig.set_size_inches(18.5, 10.5)
#fig.savefig('DCM_Quaternion_ed_test.png', dpi = 100)
#
...
#plt.show()
#fig.set_size_inches(18.5, 10.5)
#fig.savefig('DCM_Quaternion_ad_test.png', dpi = 100)